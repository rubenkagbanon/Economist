...
const I18N = {
  fr: {
    ...
    code_invalid:"Code incorrect.", code_unassigned:"Ce code n’est pas associé à votre adresse e-mail.", code_exhausted:"Code épuisé.", code_expired:"Code incorrect ou expiré. Redemandez un code.", code_in_use:"Ce compte rédige déjà sur un autre appareil.", account_not_found:"Compte introuvable.",
  ...
  en: {
    ...
    code_invalid:"Incorrect code.", code_unassigned:"This code is not associated with your email address.", code_exhausted:"Code exhausted.", code_expired:"Incorrect or expired code. Request a new code.", code_in_use:"This account is already writing on another device.", account_not_found:"Account not found.",
