...
const I18N = {
  fr: {
    ...
    toast_delete_error:"Suppression impossible. Vérifiez votre connexion.", toast_required_fields:"Remplissez tous les champs obligatoires.", toast_required_fields_proposal:"Remplissez les champs obligatoires (*).", toast_add_content:"Ajoutez du contenu à l’article.", toast_publish_error:"Publication impossible :", toast_submit_error:"Envoi pour validation impossible :", toast_submit_success:"Article bien envoyé pour validation.", toast_id_error:"impossible d'obtenir un identifiant d'article.", toast_user_error:"compte connecté introuvable.", toast_save_error:"l'enregistrement a été refusé par la base de données.",
    toast_login_required:"Connectez-vous pour proposer un article.", toast_enter_email:"Entrez votre e-mail.", toast_account_missing:"Aucun compte associé à cet e-mail.", toast_code_sent:"Code envoyé à {email}.", toast_code_active:"Un code actif existe déjà pour {email}.", toast_code_not_configured:"E-mail non configuré (voir js/email.js). Code créé : {code}",
    ...
    code_invalid:"Code incorrect.", code_unassigned:"Ce code n’est pas associé à votre adresse e-mail.", code_exhausted:"Code épuisé.", code_expired:"Code incorrect ou expiré. Redemandez un code.", code_in_use:"Ce compte rédige déjà sur un autre appareil.", account_not_found:"Compte introuvable.", session_expired:"Votre session a expiré. Reconnectez-vous et réessayez.", session_permission:"L’accès au code est refusé pour cette session. Reconnectez-vous puis réessayez.",
    confirm_delete_code:"Supprimer ce code ?", confirm_delete_proposal:"Supprimer cette proposition ?", confirm_delete_article:"Supprimer cet article ?", confirm_reject_article:"Rejeter et supprimer cet article ?", confirm_delete_account:"Supprimer définitivement le compte {email} ?",

    about_label:"À propos", about_intro_title:"EconGlobe",
    about_intro_desc:"Une plateforme pour découvrir, comprendre et faire connaître les travaux qui contribuent à mieux comprendre notre monde.",
    about_mission_title:"Notre mission", about_mission_1:"Chaque année, des milliers de recherches, mémoires, études, enquêtes, rapports et projets sont réalisés par des étudiants, des chercheurs, des professionnels, des institutions et des personnes passionnées par leur domaine. Pourtant, beaucoup de ces travaux restent peu connus, parfois même en dehors du cadre dans lequel ils ont été réalisés.", about_mission_2:"Notre plateforme permet à toute personne ayant déjà réalisé un travail pertinent de le résumer et de le partager sous la forme d’un article accessible à un public plus large. Chaque contribution est examinée avant publication afin de sélectionner des travaux qui présentent un intérêt pour nos lecteurs et qui peuvent apporter des connaissances, des éclairages ou des solutions utiles.", about_mission_3:"Notre objectif est de rapprocher la recherche et le public. En faisant circuler des connaissances déjà produites, nous voulons permettre à chacun de découvrir ce qui a été étudié, ce qui a été observé, ce qui fonctionne, ce qui peut être amélioré et ce que nous pouvons en apprendre.", about_mission_4:"Parce que les idées et les connaissances peuvent contribuer à résoudre des problèmes concrets, à améliorer nos décisions et à faire progresser nos sociétés, EconGlobe souhaite contribuer, à son échelle, à la construction d’un monde plus informé, plus innovant et capable d’apprendre de ce qui a déjà été fait.",
    about_domains_title:"Nos domaines", about_domains_1:"EconGlobe s’intéresse à tous les travaux qui permettent de mieux comprendre notre monde et ses transformations : économie, finance, politique, sociologie, droit, technologie, santé, société, environnement, intelligence artificielle, data science, ainsi que de nombreux autres domaines.", about_domains_2:"L’économie occupe une place particulière dans notre ligne éditoriale, car comprendre comment les ressources, les institutions, les marchés et les sociétés évoluent permet aussi de mieux comprendre les choix qui façonnent notre avenir.",
    about_open_title:"Un espace ouvert", about_open_1:"EconGlobe est ouvert à tous ceux qui souhaitent faire connaître un travail qu’ils ont déjà réalisé.", about_open_2:"Étudiant, chercheur, professionnel, institution ou particulier, chacun peut proposer un travail issu d’une recherche, d’un mémoire, d’une étude, d’une enquête, d’un projet ou de toute autre démarche apportant un contenu pertinent.", about_open_3:"Les travaux proposés sont examinés par notre équipe avant publication. Notre objectif est de préserver un espace sérieux, accessible et utile, tout en permettant à des travaux parfois peu visibles de trouver un nouveau public.",
    about_participate_title:"Lire, découvrir et participer", about_participate_1:"Explorez les articles publiés, découvrez leurs auteurs et parcourez les différentes thématiques d’EconGlobe.", about_participate_2:"Vous avez réalisé un travail que vous souhaitez faire connaître ?", about_participate_cta:"Proposez-le à notre rédaction.", about_participate_3:"Après examen, votre travail pourra être résumé et présenté sous la forme d’un article afin de permettre à davantage de personnes de le découvrir, de le comprendre et d’en tirer des enseignements.",
  ...
  en: {
    ...
    toast_delete_error:"Unable to delete. Check your connection.", toast_required_fields:"Please fill in all required fields.", toast_required_fields_proposal:"Please fill in the required fields (*).", toast_add_content:"Add some content to the article.", toast_publish_error:"Unable to publish:", toast_submit_error:"Unable to submit for review:", toast_submit_success:"Article successfully submitted for review.", toast_id_error:"unable to get an article ID.", toast_user_error:"the signed-in account could not be found.", toast_save_error:"the database rejected the save.",
    toast_login_required:"Log in to submit an article.", toast_enter_email:"Enter your email.", toast_account_missing:"No account is associated with this email.", toast_code_sent:"Code sent to {email}.", toast_code_active:"An active code already exists for {email}.", toast_code_not_configured:"Email is not configured (see js/email.js). Code created: {code}",
    ...
    code_invalid:"Incorrect code.", code_unassigned:"This code is not associated with your email address.", code_exhausted:"Code exhausted.", code_expired:"Incorrect or expired code. Request a new code.", code_in_use:"This account is already writing on another device.", account_not_found:"Account not found.", session_expired:"Your session has expired. Please reconnect and try again.", session_permission:"This access is denied for the current session. Please reconnect and try again.",
    confirm_delete_code:"Delete this code?", confirm_delete_proposal:"Delete this proposal?", confirm_delete_article:"Delete this article?", confirm_reject_article:"Reject and delete this article?", confirm_delete_account:"Permanently delete the account {email}?",

    about_label:"About", about_intro_title:"EconGlobe",
    about_intro_desc:"A platform for discovering, understanding and sharing work that helps us better understand our world.",
    about_mission_title:"Our mission", about_mission_1:"Every year, thousands of research projects, dissertations, studies, investigations, reports and other projects are produced by students, researchers, professionals, institutions and people passionate about their fields. Yet many of these works remain little known, sometimes even beyond the setting in which they were carried out.", about_mission_2:"Our platform allows anyone who has completed relevant work to summarize it and share it as an article accessible to a wider audience. Every contribution is reviewed before publication so we can select work that interests our readers and can offer useful knowledge, insight or solutions.", about_mission_3:"Our aim is to bring research and the public closer together. By circulating knowledge that already exists, we want everyone to discover what has been studied, observed and shown to work, what can be improved, and what we can learn from it.", about_mission_4:"Because ideas and knowledge can help solve concrete problems, improve our decisions and advance our societies, EconGlobe wants to contribute, at its own scale, to building a more informed and innovative world that can learn from what has already been done.",
    about_domains_title:"Our fields", about_domains_1:"EconGlobe is interested in work that helps us better understand our world and its transformations: economics, finance, politics, sociology, law, technology, health, society, the environment, artificial intelligence, data science and many other fields.", about_domains_2:"Economics holds a special place in our editorial approach, because understanding how resources, institutions, markets and societies evolve also helps us understand the choices shaping our future.",
    about_open_title:"An open space", about_open_1:"EconGlobe is open to everyone who wants to make work they have already completed known to a wider audience.", about_open_2:"Students, researchers, professionals, institutions and individuals can all propose work based on research, a dissertation, a study, an investigation, a project or any other process that produces relevant content.", about_open_3:"Proposed work is reviewed by our team before publication. Our aim is to preserve a serious, accessible and useful space, while helping work that is sometimes overlooked find a new audience.",
    about_participate_title:"Read, discover and participate", about_participate_1:"Explore published articles, discover their authors and browse EconGlobe’s different topics.", about_participate_2:"Have you completed work you would like to share?", about_participate_cta:"Submit it to our editorial team.", about_participate_3:"After review, your work may be summarized and presented as an article, allowing more people to discover it, understand it and learn from it.",
...
function translateLegalPages(){
  ...
  setLegalText('#privacy-article section p', [
    'This policy applies to the EconGlobe website and its reading, search, account creation and article publishing features.',
    ...
    'We use this information to create and secure accounts, display profiles and articles, enable search, manage publishing rights, measure readership and improve EconGlobe.',
    ...
    'To exercise these rights, contact the EconGlobe team using the email address linked to your account. We may request additional information to verify your identity.',
    ...
    'For questions about this policy or your data, contact the EconGlobe team through the service administration email address.'
  ]);
  ...
  setLegalText('#rules-article section p', [
    ...
    'Access to writing and publishing may require approval or a code provided by EconGlobe. This control helps preserve the quality and security of the platform.',
    ...
    'EconGlobe may hide or remove content, limit a feature or suspend an account when a rule is broken, a security risk is identified or a legal obligation requires it.',
    ...
    'EconGlobe does not guarantee that every piece of content will be published, recommended or available without interruption.',
    ...
    'If you have a question about these terms or want to report content, contact the EconGlobe team through the service administration email address.'
  ]);
}
